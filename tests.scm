...
(lambda (y z a) (- 8 3z a (* -1 y)))
; expect (lambda (y z a) (- 8 3z a (* -1 y)))
...
(and 43 8 'hello 8 False  'goodbye '5)
; expect #f
...
(or 43 8 'hello 8 False  'goodbye '5)
; expect 43

(or 0 1 'hello)
; expect 0

(define (falsefunc) (or False (and 53 289234 '23 False 783)))
; expect falsefunc
